...
if __name__ == '__main__':
    ...
    parser.add_argument('-ts', '--test_path', default='/../../lcod_testset/testset.npy', type=str,\
    ...
    parser.add_argument('-dp', '--dictionary_path', default='/../../lcod_testset/Wd.npy')

    parser.add_argument('-l', '--log_dir_path', default='../../lcod_logdir/log_dir', type=str,\
    ...
    data_gens = db_tools.trainset_gen(os.path.dirname(os.path.realpath(__file__)) + args.train_path, args.ratio)
    Wd = np.load(os.path.dirname(os.path.realpath(__file__)) + args.dictionary_path)
    approx_error = []
    sc_error     = []
