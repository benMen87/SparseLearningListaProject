...
MODEL_DIR = '/home/hillel/projects/SparseLearningListaProject/code/encoder_decoder/logdir/models/u3_kc64_ks7_normEnc_contL1SSIM'
IMAGE = '/home/hillel/projects/SparseLearningListaProject/code/encoder_decoder/test_images/images/barbara.png'
...
def load_and_shift(shifts):
    ...
    input_shape =  list(I_orig.size) + [1]
...
def denoise():
    ...
    psnr = 10 * np.log10(1 / np.mean((I_clean[pad:-pad, pad:-pad] -
        I_hat[pad:-pad, pad:-pad])**2) )
